...
% kdtree
index_of_triangles = (1:size(center_of_triangle, 1))';
kdtree = kdtree_object...
    (0, upper_bound, lower_bound, center_of_triangle, index_of_triangles);
kdtree.enlarge_bound(triangle_set);
...
for char = ['A':'H','J']
    ...
    residual_FA = zeros(num_samples, 1);
    residual_FB = zeros(num_samples, 1);
    ...
    while error_max > 0.1 && iteration < max_iteration &&...
        ...
        parfor i=1:num_samples
            ...
            [c_octree, triangle_index_octree]  = tree_main_search...
                (s, octree, triangle_set, center_of_triangle, radius);
            
            % [c_kdtree, triangle_index_kdtree]  = tree_main_search...
